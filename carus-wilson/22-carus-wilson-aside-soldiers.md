...
```{admonition} Contributing to the comfort and happiness of the soldier
:class: dropdown
...
```{admonition} Collateral advantages
:class: dropdown
...
```{admonition} Best to have it distinct from the barracks
:class: dropdown
...
```{admonition} The earthly and spiritual fight
:class: dropdown
...
```{admonition} The rules of the institution
:class: dropdown
...
The first annual report a year later, in March 1857, describes some of the successes of the Soldiers' Institute.
