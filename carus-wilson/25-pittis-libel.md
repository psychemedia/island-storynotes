...
```{admonition} A character for the strictest integrity and the greatest morality
:class: dropdown
...
```{admonition} Exposing a great vice and revering decency
:class: dropdown
