...
```{admonition} A correspondent asks, January, 1916
:class: dropdown
...
```{admonition} Another version of the rhyme, February 1916
:class: dropdown
...
```{admonition} Considerable interest generated, February 1916
:class: dropdown
...
```{admonition} Some further letters, February, 1916
:class: dropdown
...
```{admonition} Recalled to memory, February 1916
:class: dropdown
