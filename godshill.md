...
So it seemed as if someone, or some*thing*, or even the very Church itself, didn't want the Church to be *down here*, but instead wanted it to be *up there*.
...
In Sir Richard Worsley, *The History of the Isle of Wight*, 1781, [p214](https://books.google.co.uk/books?id=wOZWAAAAcAAJ&printsec=frontcover#v=onepage&q&f=false).

In the month of January, in the year one thouſand ſeven hundred and ſeventy-eight, the church was struck by lightning, and conſiderably damaged; the particulars of this ſtorm, and its effects, are described in a letter from the miniſter of the pariſh, in the following note.
...
A [little digging](https://archive.org/details/statutesatlarge50britgoog/page/n256/mode/2up) turns up the act that Hassell was perhaps referring to, although in actual terms it seems far more draconian even than Hassell described:
